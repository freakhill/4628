...
Hack.put = function() {
    ...
    (function onLoadScript() {
        ...
        if (data.length > 10) {
            ...
            var promptStr = '深夜勤務データの数が10件以上あります。\n1度に10件までしか申請できないため、範囲を指定する必要があります。\nどの範囲のデータを反映しますか？\n\n';
...
if (!window.localStorage) {
    alert('ブラウザが対応していません。バージョンアップしてからもう一度試してみてください。');
} else {
    var command = prompt('深夜勤務データの"読み込み"と"入力"のどちらを実行しますか？ "get"か"put"のどちらかを入力してください。\n\nget : データの読み込みをする\nput : データの入力をする');
